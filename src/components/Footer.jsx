    ...
    <div className="w-full bg-white py-24">
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0">
        ...
        <div>
          ...
          <ul className="py-6 text-[#6D737A]">
            <li className="py-2">Artificial Intelligence</li>
            <li className="py-2">Data Engineering</li>
            <li className="py-2">Machine Learning</li>
            <li className="py-2">Cybersecurity</li>
            <li className="py-2">Generative AI </li>
        ...
        <div className="max-[780px]:col-span-2">
          ...
          <h3 className="py-2 text-[#6D737A]">
            Start learning by registering for free.<br></br> You can also
            upgrade to a pro account to get more features.
          </h3>
          <form className="py-4">
            <input
